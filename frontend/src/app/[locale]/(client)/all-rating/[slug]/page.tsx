...
export default function AllRatingPage() {
  ...
  const filteredRatings =
    selectedVariant === "all"
      ...
      : ratings.filter(
          (r) =>
            r.variant?.rarity?.toLowerCase() === selectedVariant.toLowerCase()
        );

  return (
    <div className="container mx-auto py-10 px-20 max-w-5xl">
      ...
      <div className="space-y-4">
        {filteredRatings.map((r, i) => (
          <div
            key={i}
            className="flex gap-4 bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition"
          >
            <img
